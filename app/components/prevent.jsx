...
const preventData = {
  ...
  infoDataArr: [
    ...
    {
      title: "灵活用工机制搭建",
      content: ['在合法的前提下，通过以下一个或多个机制的搭建，帮助企业实现成本节约、风险降低、组织效率提升，实现“员工能进能出、工资能高能低、岗位能上能下”的“三能够”灵活管理目标。',
        '- 绩效考核结果的灵活运用',
        '- 多元化用工形式的搭建',
        '- 劳动合同双管制',
        '- 特殊工时制度运用与管理等'
    ...
    {
      title: "内训与公开课",
      content: ["帮助企业人力资源管理者和业务线管理者梳理员工入职、在职、离职各关键管理环节的劳动法知识与法律风险，提升人力资源管理者与非人力资源管理者在各环节的风险防控意识，通过内训或全年系统性学习，帮助掌握各环节劳动关系管理的实操技能与典型问题的应对方式，有效帮助业务线团队和人力资源管理团队达成共识。"],
